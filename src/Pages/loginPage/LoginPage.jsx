  ...
  return (
    <div className="d-flex justify-content-center align-items-center vh-100">
      <div className="poll-container text-center">
        ...
        <div className="d-flex justify-content-around mb-4 text-start">
          <div
            className={`role-btn ${selectedRole === "student" ? "active" : ""}`}
            onClick={() => selectRole("student")}
          >
            <p className="fw-bold">I'm a Student</p>
            <span>
          ...
          >
            <p className="fw-bold">I'm a Teacher</p>
            <span>Submit answers and view live poll  results in real-time.</span>
          </div>
        </div>

        <button className="btn continue-btn fw-bold" onClick={continueToPoll}>
          Continue
        </button>
      </div>
    </div>
